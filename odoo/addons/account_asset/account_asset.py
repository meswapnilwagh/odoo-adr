...
class account_asset_category(osv.osv):
    ...
    _columns = {
        ...
        'account_asset_id': fields.many2one('account.account', 'Asset Account', required=False, domain=[('type','=','other')]),
        'account_depreciation_id': fields.many2one('account.account', 'Depreciation Account', required=False, domain=[('type','=','other')]),
        ...
        'method': fields.selection([('linear','Linear'),('degressive','Degressive')], 'Computation Method', required=False, help="Choose the method to use to compute the amount of depreciation lines.\n"\
        ...
        'method_time': fields.selection([('number','Number of Depreciations'),('end','Ending Date')], 'Time Method', required=False,
