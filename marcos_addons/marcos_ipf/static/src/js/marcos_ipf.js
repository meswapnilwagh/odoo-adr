...
openerp.marcos_ipf = function (instance, local) {
    ...
    openerp.web.form.custom_widgets.add("ipf_button_softwareVersion", "instance.marcos_ipf.IpfsoftwareVersion");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_state", "instance.marcos_ipf.Ipfstate");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_printer_information", "instance.marcos_ipf.IpfPrinterInformation");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_advance_paper", "instance.marcos_ipf.IpfPrinterAdvancePaper");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_advance_pape_number", "instance.marcos_ipf.IpfPrinterAdvancePaperNumber");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_paper_cut", "instance.marcos_ipf.IpfPrinterCutPaper");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_z_close", "instance.marcos_ipf.IpfPrinterZClose");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_z_close_print", "instance.marcos_ipf.IpfPrinterZClosePrint");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_new_shift", "instance.marcos_ipf.IpfPrinterNewShift");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_new_shift_print", "instance.marcos_ipf.IpfPrinterNewShiftPrint");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_x", "instance.marcos_ipf.IpfPrinterX");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_information_day", "instance.marcos_ipf.IpfPrinterInformationDay");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_information_shift", "instance.marcos_ipf.IpfPrinterInformationShift");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_get_document_header", "instance.marcos_ipf.IpfPrinterGetDocumentHeader");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_post_document_header", "instance.marcos_ipf.IpfPrinterPostDocumentHeader");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_dailybook", "instance.marcos_ipf.IpfPrinterDailyBook");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_post_invoice", "instance.marcos_ipf.IpfPrinterPostInvoice");
};