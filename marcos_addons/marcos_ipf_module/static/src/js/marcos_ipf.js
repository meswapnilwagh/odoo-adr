...
openerp.marcos_ipf_module = function (instance, local) {
    ...
    local.ipfAPI = instance.Widget.extend({
        ...
        get_host: function (context) {
            var self = this;
            this.host = null;
            return new openerp.web.Model("mipf.printer.config").call("get_ipf_host", [], {"context": context}).then(function (data) {
                self.host = data.host;
            });
        },
        ...
        save_book: function(response, serial, bookday, context){
            var self = this;
            if (response) {
                return new openerp.web.Model("mipf.printer.config").call("save_book", [response, serial, bookday], {context: context})
                .then(function (data) {
                    if (data) {
        ...
        create_invoice: function(context){
            ...
            return new openerp.web.Model("mipf.printer.config").call("ipf_print", [], {context: context})
                .then(function (data) {
        ...
        print_done: function (context, invoice_id, nif) {
            ...
            return new openerp.web.Model("mipf.printer.config").call("print_done", [[invoice_id, nif]], {context: context})
    ...
    openerp.web.form.custom_widgets.add("ipf_button_softwareVersion", "instance.marcos_ipf_module.IpfsoftwareVersion");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_state", "instance.marcos_ipf_module.Ipfstate");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_printer_information", "instance.marcos_ipf_module.IpfPrinterInformation");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_advance_paper", "instance.marcos_ipf_module.IpfPrinterAdvancePaper");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_advance_pape_number", "instance.marcos_ipf_module.IpfPrinterAdvancePaperNumber");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_paper_cut", "instance.marcos_ipf_module.IpfPrinterCutPaper");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_z_close", "instance.marcos_ipf_module.IpfPrinterZClose");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_z_close_print", "instance.marcos_ipf_module.IpfPrinterZClosePrint");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_new_shift", "instance.marcos_ipf_module.IpfPrinterNewShift");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_new_shift_print", "instance.marcos_ipf_module.IpfPrinterNewShiftPrint");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_x", "instance.marcos_ipf_module.IpfPrinterX");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_information_day", "instance.marcos_ipf_module.IpfPrinterInformationDay");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_information_shift", "instance.marcos_ipf_module.IpfPrinterInformationShift");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_get_document_header", "instance.marcos_ipf_module.IpfPrinterGetDocumentHeader");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_post_document_header", "instance.marcos_ipf_module.IpfPrinterPostDocumentHeader");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_dailybook", "instance.marcos_ipf_module.IpfPrinterDailyBook");
    ...
    openerp.web.form.custom_widgets.add("ipf_button_post_invoice", "instance.marcos_ipf_module.IpfPrinterPostInvoice");

    local.IpfPrinterDailyBookWizad = instance.web.form.FormWidget.extend({
        events: {
            "click #get_daily_book": "get_daily_book"
        },
        start: function () {
        ...
        get_daily_book: function () {
           var self = this;
            ...
            var context = new instance.web.CompoundContext({
                ipf_id: self.field_manager.get_field_value("ipf_id"),
                from_wizard: true
            });
            var command = new local.ipfAPI();
            command.get_daily_book(context, self.field_manager.get_field_value("day"));

        }
    });

    openerp.web.form.custom_widgets.add("ipf_button_dailybookwizard", "instance.marcos_ipf_module.IpfPrinterDailyBookWizad");
