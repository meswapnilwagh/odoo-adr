(function(){
    ...
    website.add_template_file('/theme_capital/static/src/xml/s_media_block_modal_ext.xml');
    ...
    website.snippet.options.s_media_block.include({
        ...
        video_opt: function (type, value, $li) {
            ...
            self.$modal = $(openerp.qweb.render("theme_capital.s_media_block_modal_ext"));
